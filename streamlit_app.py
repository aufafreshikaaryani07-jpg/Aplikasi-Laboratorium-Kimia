...
database_alat = {
    ...
    "Gas Chromatography (GC)": {"fungsi": "Kromatografi gas untuk memisahkan dan menganalisis senyawa yang mudah menguap.", "stok": 1, "img": "Gas Chromatography (GC).jpg.jpeg"},
    ...
    "High Performance Liquid Chromatography (HPLC)": {"fungsi": "Kromatografi cair kinerja tinggi untuk memisahkan komponen dalam campuran larutan secara akurat.", "stok": 2, "img": "High Performance Liquid Chromatography (HPLC).jpg.jpeg"},
