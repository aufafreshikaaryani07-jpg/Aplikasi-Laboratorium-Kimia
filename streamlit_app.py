...
database_alat = {
    ...
    "Spektrofotometer AAS": {"fungsi": "Menganalisis konsentrasi unsur logam dalam sampel berdasarkan prinsip spektrometri serapan atom menggunakan nyala api.", "stok": 2, "img": "SpektrofotometerAAS.jpg.jpeg"},
