...
database_alat = {
    ...
    "Spektrofotometer AAS": {"fungsi": "Menganalisis konsentrasi unsur logam dalam sampel berdasarkan prinsip spektrometri serapan atom menggunakan nyala api.", "stok": 2, "img": "Spektrofotometer_AAS.jpg.jpeg"},
    "Spektrofotometer GC": {"fungsi": "Mengidentifikasi, memisahkan, dan mengukur kadar komponen senyawa organik volatil (mudah menguap) pada fase gas.", "stok": 1, "img": "Spektrofotometer_GC.jpg.jpeg"},
    "Spektrofotometer HPLC": {"fungsi": "Memisahkan komponen analit non-volatil fase cair dengan akurasi dan tekanan tinggi serta mendeteksi konsentrasinya.", "stok": 2, "img": "Spektrofotometer_HPLC.jpg.jpeg"},
    "Spektrofotometer UV-Vis": {"fungsi": "Mengukur nilai absorbansi dan transmitansi larutan berwarna pada spektrum panjang gelombang ultra-violet dan sinar tampak.", "stok": 4, "img": "Spektrofotometer_UV_Vis.jpg.jpeg"},
